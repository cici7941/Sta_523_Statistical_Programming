...
# function output: Percent of laquintas that have at least 1 denny between (low, high] miles #
#if statement is simply a patch for wercker error#
if(length(dim(distMat))>0){
